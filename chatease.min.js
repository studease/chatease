chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.0.05";
...
d.splice(b,1)}catch(m){e.log("error",m)}return!1}};this.dispatchEvent=function(k,f){f||(f={});e.extend(f,{id:g,version:b.version,type:k});b.debug&&e.log(k,f);a(c[k],f,k);a(d,f,k)}}})(chatease);
(function(b){var e=b.utils,g=b.events,a={},c={onError:g.ERROR,onReady:g.CHATEASE_READY,onConnect:g.CHATEASE_CONNECT,onIdent:g.CHATEASE_INDENT,onMessage:g.CHATEASE_MESSAGE,onJoin:g.CHATEASE_JOIN,onLeft:g.CHATEASE_LEFT,onUsers:g.CHATEASE_USERS,onNickClick:g.CHATEASE_VIEW_NICKCLICK,onClose:g.CHATEASE_CLOSE};b.api=function(a){function d(a){f.dispatchEvent(a.type,a)}var f=e.extend(this,new g.eventdispatcher("api")),m;f.container=a;f.id=a.id;f.setup=function(a){e.emptyElement(f.container);b.debug=!!a.debug;
f.config=a;f.config.id=f.id;f.embedder=new b.embed(f);f.embedder.addGlobalListener(d);f.embedder.embed();return f};f.setEntity=function(a,e){m=a;f.renderName=e;f.send=m.send;f.resize=m.resize};(function(){e.foreach(c,function(a,e){f[a]=function(a){f.addEventListener(e,a)}})})()};b.api.getInstance=function(c){var d;null==c?c=0:c.nodeType?d=c:"string"===e.typeOf(c)&&(d=document.getElementById(c));if(d){var f=a[d.id];f||(a[c]=f=new b.api(d));return f}return"number"===e.typeOf(c)?a[c]:null};b.api.displayError=
function(a,e){}})(chatease);(function(b){b.core={}})(chatease);(function(b){b.core.states={CONNECTED:"connected",CLOSED:"closed",ERROR:"error"}})(chatease);
...
c+"ico-assistant":b&a.VIP?c+("ico-vip"+((b&a.VIP)-1)):(b&a.NORMAL)==a.NORMAL?c+"ico-normal":c+"ico-visitor"}var h=e.extend(this,new g.eventdispatcher("renders.def")),v,w,p,q,y,x,u,l;h.setup=function(){};h.show=function(b,c,d){"object"!=e.typeOf(c)&&(c={id:0,name:"[\u7cfb\u7edf]",role:a.SYSTEM});"uni"!=d&&(d="multi");var f=e.createElement("div");c.role&a.SYSTEM&&(f.className="cha-system");"uni"==d&&(d=e.createElement("span"),d.innerHTML="[\u5bc6\u8bed]",f.appendChild(d));if(d=n(c.role))d=e.createElement("span",
d),f.appendChild(d);d=e.createElement("a");d.innerHTML=c.name;c=function(a){return function(b){h.dispatchEvent(g.CHATEASE_VIEW_NICKCLICK,{user:a})}}(c);try{d.addEventListener("click",c)}catch(A){d.attachEvent("onclick",c)}f.appendChild(d);f.insertAdjacentHTML("beforeend",b);p.childNodes.length>=h.config.maxrecords&&p.removeChild(p.childNodes[0]);p.appendChild(f);p.scrollTop=p.scrollHeight};h.send=function(){h.dispatchEvent(g.CHATEASE_VIEW_SEND,{data:{data:u.value,type:"multi"}});h.clearInput()};h.clearInput=
function(){u.value=""};h.clearScreen=function(){e.emptyElement(p)};h.element=function(){return v};h.resize=function(a,b){};h.destroy=function(){};h.name=c.DEFAULT;h.config=e.extend({},{},k);v=e.createElement("div","cha-render");(function(){w=e.createElement("div","cha-title");v.appendChild(w);w.innerHTML="\u804a\u5929\u5ba4";p=e.createElement("div","cha-console");v.appendChild(p);q=e.createElement("div","cha-controls");v.appendChild(q);var a=d("\u5c4f\u853d\u6d88\u606f","cha-checkbox shieldtext",
g.CHATEASE_VIEW_PROPERTY,{key:"shield"},!1);q.appendChild(a);a=m("\u6e05\u5c4f","cha-button clearscreen",g.CHATEASE_VIEW_CLEARSCREEN,null);q.appendChild(a);y=e.createElement("div","cha-dialog");v.appendChild(y);x=e.createElement("div","cha-input");y.appendChild(x);u=e.createElement("textarea");x.appendChild(u);l=e.createElement("button");x.appendChild(l);u.setAttribute("placeholder","\u8f93\u5165\u804a\u5929\u5185\u5bb9");h.config.maxlength&&u.setAttribute("maxlength",h.config.maxlength);a=function(){return function(a){a=
window.event||a;13==a.keyCode&&(a.ctrlKey?u.value+="\r\n":(h.send(),window.event?a.returnValue=!1:a.preventDefault()))}}();try{u.addEventListener("keypress",a)}catch(C){u.attachEvent("onkeypress",a)}l.innerHTML="\u53d1\u9001";a=function(){return function(){h.send()}}();try{l.addEventListener("click",a)}catch(C){l.attachEvent("onclick",a)}})()}})(chatease);
(function(b){var e=b.utils,g=b.events,a=b.core;a.entity=function(b){var c=e.extend(this,new g.eventdispatcher("core.entity")),k,f,m;c.setup=function(){setTimeout(function(){f.setup()},0)};c.destroy=function(){m&&m.stop();f&&f.destroy();k&&k.destroy()};c.id=b.id;c.model=k=new a.model(b);c.view=f=new a.view(c,k);c.controller=m=new a.controller(k,f);m.addGlobalListener(function(a){c.dispatchEvent(a.type,a)});c.send=m.send;c.getState=k.getState;c.resize=f.resize}})(chatease);
(function(b){var e=b.utils,g=b.events;b=b.core;var a=b.states,c=b.protocol,d=c.roles,k=c.channelStates,f=c.punishments,m=function(){var a=this;_interval=-1;_active=0;a.set=function(b){e.extend(a,b);1==b.hasOwnProperty("role")&&(b=b.role,_interval=0>b?-1:b>=d.ASSISTANT?0:b&d.VIP?500:b==d.NORMAL?1E3:2E3)};a.isMuted=function(){return!!(a.state&k.MUTED|a.punishment.code&f.MUTED)};a.isActive=function(){if(0>_interval)return!1;var a=(new Date).getTime();if(_active&&a-_active<_interval)return!1;_active=
a;return!0};e.extend(a,{channel:null,role:-1,state:0,punishment:{code:0,time:0}})};b.model=function(b){var c=e.extend(this,new g.eventdispatcher("core.model")),d=a.STOPPED,f;c.setState=function(a){a!==d&&(d=a,c.dispatchEvent(g.CHATEASE_STATE,{state:a}))};c.getState=function(){return d};c.setProperty=function(a,b){1==f.hasOwnProperty(a)&&(f[a]=b,c.dispatchEvent(g.CHATEASE_PROPERTY,{key:a,value:b}))};c.getProperty=function(a){return f[a]};c.getConfig=function(a){return c.config[a]||{}};c.destroy=function(){};
c.config=e.extend({},{},b);f={userinfo:new m,shield:!1}}})(chatease);
(function(b){var e=b.utils,g=b.events;b=b.core;var a=b.protocol.roles,c=b.renders,d=b.skins;b.view=function(b,f){function k(){var a=e.extend({},f.getConfig("render"),{id:b.id,width:f.config.width,height:f.config.height,maxlength:f.maxlength,maxrecords:f.maxRecords});try{l=p.render=new c[a.name](p,a),l.addEventListener(g.CHATEASE_VIEW_SEND,w),l.addEventListener(g.CHATEASE_VIEW_PROPERTY,w),l.addEventListener(g.CHATEASE_VIEW_CLEARSCREEN,w),l.addEventListener(g.CHATEASE_VIEW_NICKCLICK,w),l.addEventListener(g.CHATEASE_RENDER_ERROR,
v)}catch(t){e.log("Failed to init render "+a.name+"!")}l&&q.replaceChild(l.element(),y)}function n(){var a=e.extend({},f.getConfig("skin"),{id:b.id,width:f.config.width,height:f.config.height});try{r=new d[a.name](a)}catch(t){e.log("Failed to init skin "+a.name+"!")}}function h(a){if(a.ctrlKey||a.metaKey)return!0;switch(a.keyCode){case 13:l.send()}if(/13|32/.test(a.keyCode))return a.preventDefault?a.preventDefault():a.returnValue=!1,!1}function v(a){w(a)}function w(a){p.dispatchEvent(a.type,a)}var p=
e.extend(this,new g.eventdispatcher("core.view")),q,y,x,u,l,r;p.setup=function(){if(l){l.setup();try{q.addEventListener("keydown",h)}catch(C){q.attachEvent("onkeydown",h)}p.dispatchEvent(g.CHATEASE_READY)}else p.dispatchEvent(g.CHATEASE_SETUP_ERROR,{message:"Render not available!",name:f.config.render.name})};p.show=function(b,c,e){(!c||c.role&a.SYSTEM||!f.getProperty("shield"))&&l&&l.show(b,c,e)};p.resize=function(a,b){l&&l.resize(a,b);r&&r.resize(a,b)};p.destroy=function(){q&&q.removeEventListener("keydown",
h);l&&l.destroy()};(function(){q=e.createElement("div","cha-wrapper cha-skin-"+f.config.skin.name);q.id=b.id;q.tabIndex=0;y=e.createElement("div","cha-render");x=e.createElement("div","cha-poster");u=e.createElement("div","cha-contextmenu");q.appendChild(y);q.appendChild(x);q.appendChild(u);k();n();var a=document.getElementById(b.id);a.parentNode.replaceChild(q,a);window.onresize=function(){"function"==e.typeOf(f.config.onresize)&&f.config.onresize.call(null)}})()}})(chatease);
(function(b){var e=b.utils,g=b.events;b=b.core;var a=b.states,c=b.protocol,d=c.cmds,k=c.raws,f=c.roles,m=c.channelStates,n=c.punishments,h=c.errors;b.controller=function(b,c){function p(){if(t&&b.state!=a.CONNECTED)e.log("Websocket had connected already.");else{c.show("\u804a\u5929\u5ba4\u8fde\u63a5\u4e2d\u2026");try{t=window.WebSocket?new WebSocket(b.config.url):window.MozWebSocket?new MozWebSocket(b.config.url):new SockJS(b.config.url.replace(/^ws/,"http")+"/sockjs")}catch(z){e.log("Failed to initialize websocket: "+
z);return}t.onopen=function(c){b.setState(a.CONNECTED)};t.onmessage=q;t.onerror=function(c){b.setState(a.ERROR)};t.onclose=function(c){b.setState(a.CLOSED)}}}function q(a){var d;try{d=eval("("+a.data+")")}catch(D){e.log("Failed to parse JSON. \nError: "+D+"\ndata: "+a.data);return}switch(d.raw){case k.IDENT:a=b.getProperty("userinfo");a.set(e.extend({},d.user,{channel:d.channel.id,state:d.channel.state}));c.show("\u5df2\u52a0\u5165\u623f\u95f4\uff08"+a.channel+"\uff09\u3002");a.state&m.MUTED&&c.show("\u60a8\u6240\u5728\u7684\u7528\u6237\u7ec4\u4e0d\u80fd\u53d1\u8a00\uff01");
if(a.punishment.code&n.MUTED){var f=new Date;f.setTime(a.punishment.time);c.show("\u60a8\u5df2\u88ab\u7981\u8a00\u81f3\uff08"+e.formatTime(f)+"\uff09\uff01")}r.dispatchEvent(g.CHATEASE_INDENT,d);break;case k.TEXT:try{B||(B=new e.filter(b.keywords)),d.data=B.replace(d.data)}catch(D){e.log("Failed to execute filter.")}c.show(d.data,d.user,d.type);r.dispatchEvent(g.CHATEASE_MESSAGE,d);break;case k.JOIN:a=v(d.user.role);c.show((a?a+" ":"")+d.user.name+" \u8fdb\u5165\u623f\u95f4\u3002");r.dispatchEvent(g.CHATEASE_JOIN,
d);break;case k.LEFT:a=v(d.user.role);c.show((a?a+" ":"")+d.user.name+" \u5df2\u79bb\u5f00\u3002");r.dispatchEvent(g.CHATEASE_LEFT,d);break;case k.USERS:r.dispatchEvent(g.CHATEASE_USERS,d);break;case k.ERROR:x(d.error.code,d);break;default:e.log("Unknown data type: "+d.raw+", ignored.")}}function v(a){var b="";if("number"!=e.typeOf(a)&&(a=parseInt(a),NaN==a||0>a))return"";a&f.SYSTEM?b=(a&f.SYSTEM)==f.SYSTEM?b+"[\u7cfb\u7edf]":a&f.SU_ADMIN?b+"[\u8d85\u7ba1]":b+"[\u7ba1\u7406\u5458]":a&f.ANCHOR?b=(a&
f.ANCHOR)==f.ANCHOR?b+"[\u4e3b\u64ad]":a&f.SECRETARY?b+"[\u52a9\u7406]":b+"[\u623f\u7ba1]":a&f.VIP?b+="[VIP"+((a&f.VIP)-1)+"]":(a&f.NORMAL)!=f.NORMAL&&(b+="[\u6e38\u5ba2]");return b}function x(a,b){var d=u(a);d&&c.show(d);var f={raw:"error",error:{code:a,explain:d}};e.foreach(b,function(a,b){"cmd"!=a&&"raw"!=a&&"error"!=a&&(f[a]=b)});r.dispatchEvent(g.ERROR,f)}function u(a){var b="";switch(a){case h.BAD_REQUEST:b="\u9519\u8bef\u8bf7\u6c42\uff01";break;case h.UNAUTHORIZED:b="\u8bf7\u5148\u767b\u5f55\uff01";
...
function l(a){r.dispatchEvent(a.type,a)}var r=e.extend(this,new g.eventdispatcher("core.controller")),w=!1,t,B,A=0;r.send=function(c){if(t&&b.state!=a.CLOSED)if("object"!=e.typeOf(c)||0==c.hasOwnProperty("cmd"))x(h.BAD_REQUEST,c);else{var d=b.getProperty("userinfo");0==d.isActive()?x(h.CONFLICT,c):1==d.isMuted()?x(h.FORBIDDED,c):t.send(JSON.stringify(c))}else p()};r.close=function(){t&&t.close()};b.addEventListener(g.CHATEASE_STATE,function(d){switch(d.state){case a.CONNECTED:c.show("\u804a\u5929\u5ba4\u5df2\u8fde\u63a5\u2026");
A=0;r.dispatchEvent(g.CHATEASE_CONNECT);break;case a.CLOSED:c.show("\u804a\u5929\u5ba4\u8fde\u63a5\u5df2\u65ad\u5f00\uff01");r.dispatchEvent(g.CHATEASE_CLOSE,{channel:{id:b.channel}});if(0>b.config.maxretries||A<b.config.maxretries)d=Math.ceil(b.config.retrydelay+5E3*Math.random()),c.show("\u6b63\u5728\u51c6\u5907\u91cd\u8fde\uff0c"+d/1E3+"\u79d2..."),A++,t=null,setTimeout(p,d);break;case a.ERROR:c.show("\u804a\u5929\u5ba4\u5f02\u5e38\uff01");r.dispatchEvent(g.ERROR,{message:"Chat room error!",channel:{id:b.channel}});
break;default:r.dispatchEvent(g.ERROR,{message:"Unknown model state!",state:d.state})}});b.addEventListener(g.CHATEASE_PROPERTY,function(a){l(a)});c.addEventListener(g.CHATEASE_READY,function(c){w||(w=!0,l(c),p(),window.onbeforeunload=function(c){t&&b.state==a.CONNECTED&&t.close()})});c.addEventListener(g.CHATEASE_SETUP_ERROR,function(c){b.setState(a.ERROR);l(c)});c.addEventListener(g.CHATEASE_VIEW_SEND,function(a){var f=a.data.data;if(f){0<=b.config.maxlength&&(f=f.substr(0,b.config.maxlength));
var f=e.trim(f),g=b.getProperty("userinfo");r.send({cmd:d.TEXT,data:f,type:a.data.type,channel:{id:g.channel}})}else c.show("\u8bf7\u8f93\u5165\u5185\u5bb9\uff01")});c.addEventListener(g.CHATEASE_VIEW_PROPERTY,function(a){b.setProperty(a.key,a.value)});c.addEventListener(g.CHATEASE_VIEW_CLEARSCREEN,function(a){c.render.clearScreen();l(a)});c.addEventListener(g.CHATEASE_VIEW_NICKCLICK,function(a){var c=b.getProperty("userinfo");a.channel={id:c.channel,state:c.state};l(a)});c.addEventListener(g.CHATEASE_RENDER_ERROR,
function(c){b.setState(a.ERROR);l(c)})}})(chatease);
(function(b){var e=b.utils,g=b.events,a=b.embed=function(c){function d(a){switch(a.type){case g.ERROR:case g.CHATEASE_SETUP_ERROR:case g.CHATEASE_RENDER_ERROR:k.errorScreen(a.message);k.dispatchEvent(g.ERROR,a);break;default:k.dispatchEvent(a.type,a)}}var k=e.extend(this,new g.eventdispatcher("embed")),f={},m=null,n=!1;k.embed=function(){try{f=new a.config(c.config),m=new a.embedder(c,f)}catch(h){e.log("Failed to init embedder!");k.dispatchEvent(g.CHATEASE_SETUP_ERROR,{message:"Failed to init embedder!",
render:f.render.name});return}m.addGlobalListener(d);m.embed()};k.errorScreen=function(a){n||(n=!0,b.api.displayError(a,f))};(function(){e.foreach(c.config.events,function(a,b){a=c[a];"function"===e.typeOf(a)&&a.call(c,b)})})()}})(chatease);
