...
d("."+e+" .cha-render .cha-controls .shieldtext",{"float":"left"});d("."+e+" .cha-render .cha-controls .clearscreen",{"float":"right",width:"42px"});d("."+e+" .cha-render .cha-dialog",{width:"100%",height:"60px",overflow:"hidden"});d("."+e+" .cha-render .cha-dialog textarea",{"margin-right":"6px",padding:"6px 10px",width:f.config.width-124+"px",height:"48px",resize:"none",border:"0 none","background-color":"#E6E6E6"});d("."+e+" .cha-render .cha-dialog button",{"float":"right",width:"42px",height:"48px"})}})(chatease);
