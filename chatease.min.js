chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.0.02";
...
NOT_IMPLEMENTED:501,BAD_GATEWAY:502,SERVICE_UNAVAILABLE:503,GATEWAY_TIMEOUT:504}})(chatease);(function(b){b.core.skins={}})(chatease);(function(b){b.core.skins.modes={DEFAULT:"def"}})(chatease);
...
if(a.punishment.code&n.MUTED){var f=new Date;f.setTime(a.punishment.time);c.show("\u60a8\u5df2\u88ab\u7981\u8a00\u81f3\uff08"+e.formatTime(f)+"\uff09\uff01")}r.dispatchEvent(g.CHATEASE_INDENT,d);break;case k.TEXT:try{B||(B=new e.filter(b.keywords)),d.text=B.replace(d.text)}catch(D){e.log("Failed to execute filter.")}c.show(d.text,d.user,d.type);r.dispatchEvent(g.CHATEASE_MESSAGE,d);break;case k.JOIN:a=v(d.user.role);c.show((a?a+" ":"")+d.user.name+" \u8fdb\u5165\u623f\u95f4\u3002");r.dispatchEvent(g.CHATEASE_JOIN,
d);break;case k.LEFT:a=v(d.user.role);c.show((a?a+" ":"")+d.user.name+" \u5df2\u79bb\u5f00\u3002");r.dispatchEvent(g.CHATEASE_LEFT,d);break;case k.ERROR:x(d.error.code,d);break;default:e.log("Unknown data type: "+d.raw+", ignored.")}}function v(a){var b="";if("number"!=e.typeOf(a)&&(a=parseInt(a),NaN==a||0>a))return"";a&f.SYSTEM?b=(a&f.SYSTEM)==f.SYSTEM?b+"[\u7cfb\u7edf]":a&f.SU_ADMIN?b+"[\u8d85\u7ba1]":b+"[\u7ba1\u7406\u5458]":a&f.ANCHOR?b=(a&f.ANCHOR)==f.ANCHOR?b+"[\u4e3b\u64ad]":a&f.SECRETARY?
b+"[\u52a9\u7406]":b+"[\u623f\u7ba1]":a&f.VIP?b+="[VIP"+((a&f.VIP)-1)+"]":(a&f.NORMAL)!=f.NORMAL&&(b+="[\u6e38\u5ba2]");return b}function x(a,b){var d=u(a);d&&c.show(d);var f={raw:"error",error:{code:a,explain:d}};e.foreach(b,function(a,b){"cmd"!=a&&"raw"!=a&&"error"!=a&&(f[a]=b)});r.dispatchEvent(g.ERROR,f)}function u(a){var b="";switch(a){case h.BAD_REQUEST:b="\u9519\u8bef\u8bf7\u6c42\uff01";break;case h.UNAUTHORIZED:b="\u8bf7\u5148\u767b\u5f55\uff01";break;case h.FORBIDDED:b="\u6743\u9650\u9519\u8bef\uff01";
break;case h.NOT_FOUND:b="\u672a\u77e5\u8bf7\u6c42\uff01";break;case h.CONFLICT:b="\u64cd\u4f5c\u9891\u7e41\uff01";break;case h.INTERNAL_SERVER_ERROR:b="\u5185\u90e8\u9519\u8bef\uff01";break;case h.NOT_IMPLEMENTED:b="\u65e0\u6cd5\u8bc6\u522b\uff01";break;case h.BAD_GATEWAY:b="\u54cd\u5e94\u65e0\u6548\uff01";break;case h.SERVICE_UNAVAILABLE:b="\u670d\u52a1\u8fc7\u8f7d\uff01";break;case h.GATEWAY_TIMEOUT:b="\u7f51\u5173\u8d85\u65f6\uff01"}return b}function l(a){r.dispatchEvent(a.type,a)}var r=e.extend(this,
new g.eventdispatcher("core.controller")),w=!1,t,B,A=0;r.send=function(c){if(t&&b.state!=a.CLOSED)if("object"!=e.typeOf(c)||0==c.hasOwnProperty("cmd"))x(h.BAD_REQUEST,c);else{var d=b.getProperty("userinfo");0==d.isActive()?x(h.CONFLICT,c):1==d.isMuted()?x(h.FORBIDDED,c):t.send(JSON.stringify(c))}else p()};r.close=function(){t&&t.close()};b.addEventListener(g.CHATEASE_STATE,function(d){switch(d.state){case a.CONNECTED:c.show("\u804a\u5929\u5ba4\u5df2\u8fde\u63a5\u2026");A=0;r.dispatchEvent(g.CHATEASE_CONNECT);
break;case a.CLOSED:c.show("\u804a\u5929\u5ba4\u8fde\u63a5\u5df2\u65ad\u5f00\uff01");r.dispatchEvent(g.CHATEASE_CLOSE,{channel:{id:b.channel}});if(0>b.config.maxretries||A<b.config.maxretries)d=Math.ceil(b.config.retrydelay+5E3*Math.random()),c.show("\u6b63\u5728\u51c6\u5907\u91cd\u8fde\uff0c"+d/1E3+"\u79d2..."),A++,t=null,setTimeout(p,d);break;case a.ERROR:c.show("\u804a\u5929\u5ba4\u5f02\u5e38\uff01");r.dispatchEvent(g.ERROR,{message:"Chat room error!",channel:{id:b.channel}});break;default:r.dispatchEvent(g.ERROR,
{message:"Unknown model state!",state:d.state})}});b.addEventListener(g.CHATEASE_PROPERTY,function(a){l(a)});c.addEventListener(g.CHATEASE_READY,function(c){w||(w=!0,l(c),p(),window.onbeforeunload=function(c){t&&b.state==a.CONNECTED&&t.close()})});c.addEventListener(g.CHATEASE_SETUP_ERROR,function(c){b.setState(a.ERROR);l(c)});c.addEventListener(g.CHATEASE_VIEW_SEND,function(a){var f=a.data.text;if(f){0<=b.config.maxlength&&(f=f.substr(0,b.config.maxlength));var f=e.trim(f),g=b.getProperty("userinfo");
r.send({cmd:d.TEXT,text:f,type:a.data.type,channel:{id:g.channel}})}else c.show("\u8bf7\u8f93\u5165\u5185\u5bb9\uff01")});c.addEventListener(g.CHATEASE_VIEW_PROPERTY,function(a){b.setProperty(a.key,a.value)});c.addEventListener(g.CHATEASE_VIEW_CLEARSCREEN,function(a){c.render.clearScreen();l(a)});c.addEventListener(g.CHATEASE_VIEW_NICKCLICK,function(a){var c=b.getProperty("userinfo");a.channel={id:c.channel,state:c.state};l(a)});c.addEventListener(g.CHATEASE_RENDER_ERROR,function(c){b.setState(a.ERROR);
l(c)})}})(chatease);
(function(b){var e=b.utils,g=b.events,a=b.embed=function(c){function d(a){switch(a.type){case g.ERROR:case g.CHATEASE_SETUP_ERROR:case g.CHATEASE_RENDER_ERROR:k.errorScreen(a.message);k.dispatchEvent(g.ERROR,a);break;default:k.dispatchEvent(a.type,a)}}var k=e.extend(this,new g.eventdispatcher("embed")),f={},m=null,n=!1;k.embed=function(){try{f=new a.config(c.config),m=new a.embedder(c,f)}catch(h){e.log("Failed to init embedder!");k.dispatchEvent(g.CHATEASE_SETUP_ERROR,{message:"Failed to init embedder!",render:f.render.name});
return}m.addGlobalListener(d);m.embed()};k.errorScreen=function(a){n||(n=!0,b.api.displayError(a,f))};(function(){e.foreach(c.config.events,function(a,b){a=c[a];"function"===e.typeOf(a)&&a.call(c,b)})})()}})(chatease);
