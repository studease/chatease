chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="1.0.09";
...
d(".cha-wrapper *",{margin:"0",padding:"0","font-family":"Microsoft YaHei,arial,sans-serif","font-size":"14px","font-weight":"normal","box-sizing":"content-box"});d("."+e+" .cha-button",{padding:"6px 14px","font-style":"normal","font-weight":"normal","text-align":"center","text-transform":"uppercase","white-space":"nowrap","word-spacing":"normal",border:"none","border-radius":"2px",cursor:"pointer",display:"inline-block","-webkit-font-smoothing":"subpixel-antialiased","-moz-osx-font-smoothing":"grayscale",
transition:"150ms ease-in-out","transition-property":"background-color, color"});d("."+e+" .cha-button.red",{color:"#FFFFFF","background-color":"#FF0046"});d("."+e+" .cha-button.red:hover",{"background-color":"#97052D"});d("."+e+" .cha-render",{width:"100%",height:"100%"});d("."+e+" .cha-render .cha-title",{width:"100%",height:"40px","font-family":"inherit","font-weight":"normal","text-align":"center","line-height":"40px",color:"#E6E6E6","background-color":"#171717",cursor:"default","pointer-events":"none"});
d("."+e+" .cha-render .cha-console",{height:f.config.height-140+"px",color:"#242424","background-color":"#F8F8F8","overflow-y":"scroll"});d("."+e+" .cha-render .cha-console > div",{margin:"6px","word-break":"break-all","word-wrap":"break-word"});d("."+e+" .cha-render .cha-console > div.cha-system, ."+e+" .cha-render .cha-console > div.cha-system > a",{"font-style":"normal","font-weight":"normal",color:"#33CC00",cursor:"default","pointer-events":"none"});d("."+e+" .cha-render .cha-console > div > span.ico-visitor",
{"margin-right":"6px"});d("."+e+" .cha-render .cha-console > div > span.ico-normal",{"margin-right":"6px"});d("."+e+" .cha-render .cha-console > div > a",{color:"#3C9CFE","text-decoration":"none",cursor:"pointer"});d("."+e+" .cha-render .cha-controls",{width:"100%",height:"40px","line-height":"100%","background-color":"#171717",overflow:"hidden"});d("."+e+" .cha-render .cha-controls > *",{margin:"6px 0","text-align":"center",display:"block"});d("."+e+" .cha-render .cha-controls > .cha-checkbox",{padding:"6px 0 6px 20px",
color:"#E6E6E6",cursor:"pointer",background:"url(../skins/checkbox.png) no-repeat left center",overflow:"hidden"});d("."+e+" .cha-render .cha-controls > .cha-checkbox[checked=true]",{background:"url(../skins/checkbox-on.png) no-repeat left center"});d("."+e+" .cha-render .cha-controls .shieldtext",{"float":"left"});d("."+e+" .cha-render .cha-controls .clearscreen",{"float":"right",width:"42px"});d("."+e+" .cha-render .cha-dialog",{width:"100%",height:"60px",overflow:"hidden"});d("."+e+" .cha-render .cha-dialog textarea",
{"margin-right":"6px",padding:"6px 10px",width:f.config.width-124+"px",height:"48px",resize:"none",border:"0 none","background-color":"#E6E6E6"});d("."+e+" .cha-render .cha-dialog button",{"float":"right",width:"42px",height:"48px"})}})(chatease);(function(b){b.core.renders={}})(chatease);(function(b){b.core.renders.modes={DEFAULT:"def"}})(chatease);
