...
a;return!0};e.extend(a,{channel:null,role:-1,state:0,punishment:{code:0,time:0}})};b.model=function(b){var c=e.extend(this,new g.eventdispatcher("core.model")),d=a.STOPPED,f;c.setState=function(a){a!==d&&(d=a,c.dispatchEvent(g.CHATEASE_STATE,{state:a}))};c.setProperty=function(a,b){1==f.hasOwnProperty(a)&&(f[a]=b,c.dispatchEvent(g.CHATEASE_PROPERTY,{key:a,value:b}))};c.getProperty=function(a){return f[a]};c.getConfig=function(a){return c.config[a]||{}};c.destroy=function(){};c.config=e.extend({},
