chatease=function(){if(chatease.api)return chatease.api.getInstance.apply(this,arguments)};chatease.version="0.1.02";chatease.debug=!1;
...
function m(a){var b="";switch(f.typeOf(a)){case "string":if(a=parseInt(a),NaN==a||0>a)break;case "number":a&192?b="\u8d85\u7ba1":a&32?b="\u4e3b\u64ad":a&24?b="\u623f\u7ba1":a&7&&(b="VIP"+(a&7))}return b}function l(){if(!a.maxRetries||r<a.maxRetries)b.show("\u6b63\u5728\u51c6\u5907\u91cd\u8fde..."),setTimeout(function(){r++;n=null;d()},a.retryDelay+5*Math.random())}function q(a){p.dispatchEvent(a.type,a)}var p=f.extend(this,new e.eventdispatcher("core.controller")),v=!1,n,u=0,r=0;p.send=function(b,
e){n&&a.state!=c.CLOSED?n.send(b.substr(0,30)):d()};p.close=function(){n&&n.close()};a.addEventListener(e.CHATEASE_STATE,function(d){switch(d.state){case c.CONNECTED:b.show("\u804a\u5929\u5ba4\u5df2\u8fde\u63a5\u3002");r=0;p.dispatchEvent(e.CHATEASE_CONNECT,{channelId:a.id});break;case c.CLOSED:b.show("\u804a\u5929\u5ba4\u8fde\u63a5\u5df2\u65ad\u5f00\uff01");p.dispatchEvent(e.CHATEASE_CLOSE,{channelId:a.id});l();break;case c.ERROR:b.show("\u804a\u5929\u5ba4\u5f02\u5e38\uff01");p.dispatchEvent(e.CHATEASE_ERROR,
{message:"Chat room error!",channelId:a.id});break;default:p.dispatchEvent(e.CHATEASE_ERROR,{message:"Unknown model state!",state:d.state})}});a.addEventListener(e.CHATEASE_VIEW_SHIELDMSG,function(a){q(a)});b.addEventListener(e.CHATEASE_READY,function(b){v||(q(b),v=!0,d(),window.onbeforeunload=function(b){n&&a.state==c.CONNECTED&&n.close()})});b.addEventListener(e.CHATEASE_VIEW_SEND,function(c){if(c&&c.message){var d=(new Date).getTime();0<=a.messageInterval&&d-u<a.messageInterval?b.show("\u64cd\u4f5c\u9891\u7e41\uff01"):
(u=d,p.send(c.message,c.userId))}else b.show("\u8bf7\u8f93\u5165\u5185\u5bb9\uff01")});b.addEventListener(e.CHATEASE_VIEW_SHIELDMSG,function(b){a.setMsgShield(b.shield)});b.addEventListener(e.CHATEASE_VIEW_CLEARSCREEN,function(a){b.render.clearScreen();q(a)});b.addEventListener(e.CHATEASE_VIEW_NICKCLICK,function(a){q(a)});b.addEventListener(e.CHATEASE_SETUP_ERROR,function(a){q(a)});b.addEventListener(e.CHATEASE_RENDER_ERROR,function(a){q(a)})}})(chatease);
